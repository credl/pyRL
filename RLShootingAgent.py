...
#                tf.keras.layers.Conv2D(64, kernel_size=(3, 3), strides=(1, 1), padding='same', activation="relu"),
    ...
    tr = RLFramework.RLTrainer(env, nn=net, nn_learning_rate=0.1, alpha_q_learning_rate=0.2, exploration_rate_start=1.0, exploration_rate_decrease=0.000001, visualize_interval=1, load_path="./m.h5", save_path="./m.h5", save_interval=10)
